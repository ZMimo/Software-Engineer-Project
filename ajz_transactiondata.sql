...
CREATE TABLE `transactiondata` (
  `idMasterData` int NOT NULL,
  `InitialCost` varchar(45) DEFAULT NULL,
  `FinalCost` varchar(45) DEFAULT NULL,
  `NetCost` varchar(45) DEFAULT NULL,
  PRIMARY KEY (`idMasterData`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci COMMENT='This table will hold all of the information regarding the prices and the purchases of the items in the masterdata table\n';
